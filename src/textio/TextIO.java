 ...
 * error will be translated into an IllegalArgumentException.
 *
 ...
 *
 * This class does not use optimal Java programming practices.  It is designed specifically to be easily
 ...
 *
 * This class requires Java 5.0 or higher. (A previous version of TextIO required only Java 1.1;
 ...
 *
 * TextIO must be imported from package textio to be used.  (Previous versions were in the
...
public class TextIO {
   ...
   * input.  If an error occurs while trying to open the file, an exception of type IllegalArgumentException
   ...
   * output.  If an error occurs while trying to open the file, an exception of type IllegalArgumentException
